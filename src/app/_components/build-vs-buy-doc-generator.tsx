  ...
  return (
    <Card className="p-4 space-y-3">
      <div className="flex justify-between items-start">
        ...
        <Badge className={ratingColors[rating]}>{rating.replace('_', ' ').toUpperCase()}</Badge>
      </div>
...
function EvaluationResults({
  ...
  return (
    <div className="space-y-6 mt-8">
      {evaluation.stateComplexityAnalysis &&
        isCompleteCriterion(evaluation.stateComplexityAnalysis) && (
          <CriterionCard
      ...
      {evaluation.requirementsClarityAnalysis &&
        isCompleteCriterion(evaluation.requirementsClarityAnalysis) && (
          <CriterionCard
      ...
      {evaluation.categoryMaturityAnalysis &&
        isCompleteCriterion(evaluation.categoryMaturityAnalysis) && (
          <CriterionCard
      ...
      {evaluation.resourceConsiderationAnalysis &&
        isCompleteCriterion(evaluation.resourceConsiderationAnalysis) && (
          <CriterionCard
      ...
      {allQuestions.length > 0 && (
        <QuestionResponses questions={allQuestions} onSubmit={onAnswerSubmit} />
      )}
      {evaluation.finalRecommendation &&
        isCompleteRecommendation(evaluation.finalRecommendation) && (
...
const syntheticData = {
  ...
  stateDescription:
    'Complex distributed system requiring real-time updates, caching layers, and multi-region deployment.',
  requirementsClarity: 'evolving',
  mvpDescription:
    'Basic document search with AI summaries, supporting PDF and Word documents initially.',
  evolutionPath:
    'Planning to add real-time collaboration, more file types, and advanced AI features.',
  categoryMaturity: 'emerging',
  existingSolutions:
    'Evaluated Elastic, Algolia, and custom solutions. Each has tradeoffs in AI capabilities vs. search performance.',
  teamCapabilities:
    'Strong backend team with ML experience, previous search implementation experience.',
};
  ...
  const fillSyntheticData = () => {
    ...
    ['stateComplexity', 'requirementsClarity', 'categoryMaturity'].forEach(name => {
      const radio = formRef.current?.querySelector(
        `input[name="${name}"][value="${syntheticData[name as keyof typeof syntheticData]}"]`
      ) as HTMLInputElement;
      if (radio) {
        radio.checked = true;
      }
  ...
  return (
    <Card className="p-6 my-8">
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-xl font-bold">Build vs Buy Decision Framework</h3>
        {isSuperuser && (
          <Button type="button" variant="outline" onClick={fillSyntheticData} className="text-sm">
            Quick Fill
          </Button>
        )}
      </div>
        ...
        <div className="space-y-4">
          ...
          <RadioGroup name="stateComplexity" defaultValue="medium">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="state-medium">
                Medium - Moderate complexity, manageable infrastructure
              </Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="high" id="state-high" />
              <Label htmlFor="state-high">
                High - Complex state management, significant infrastructure
              </Label>
            </div>
          </RadioGroup>
          <Textarea
        ...
        <div className="space-y-4">
          ...
          <RadioGroup name="requirementsClarity" defaultValue="evolving">
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="req-clear">
                Clear - Well-defined requirements with minimal expected changes
              </Label>
            </div>
            <div className="flex items-center space-x-2">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="req-unclear">
                Unclear - Requirements are likely to change significantly
              </Label>
            </div>
          </RadioGroup>
          <div className="space-y-4">
        ...
        <div className="space-y-4">
          ...
          <RadioGroup name="categoryMaturity" defaultValue="established">
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="cat-emerging">
                Emerging - New technology, rapidly evolving best practices
              </Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="established" id="cat-established" />
              <Label htmlFor="cat-established">
                Established - Stable technology with some innovation
              </Label>
            </div>
            <div className="flex items-center space-x-2">
              <RadioGroupItem value="mature" id="cat-mature" />
              <Label htmlFor="cat-mature">
                Mature - Well-understood technology, clear best practices
              </Label>
            </div>
          </RadioGroup>
          <div className="space-y-4">
